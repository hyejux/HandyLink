...
export declare const MarkerClusterer: React.ForwardRefExoticComponent<{
    /**
     * 클러스터의 격자 크기. 화면 픽셀 단위이며 해당 격자 영역 안에 마커가 포함되면 클러스터에 포함시킨다
     * @default 60
     */
     ...
     * 클러스터의 스타일. 여러개를 선언하면 calculator 로 구분된 사이즈 구간마다 서로 다른 스타일을 적용시킬 수 있다
     */
    styles?: React.CSSProperties[] | object[] | undefined;
    /**
     * 클러스터에 표시할 문자열 또는 문자열 생성 함수.
     * @default "클러스터에 포함된 숫자"
     */
    texts?: string[] | ((size: number) => string) | undefined;
    /**
     * 클러스터 크기를 구분하는 값을 가진 배열 또는 구분값 생성함수
     * @default [10, 100, 1000, 10000]
     */
    calculator?: number[] | ((size: number) => number[]) | undefined;
    /**
     * 클러스터 클릭 시 지도 확대 여부. true로 설정하면 클러스터 클릭 시 확대 되지 않는다
     * @default false
     */
     ...
     * 클러스터 마커를 클릭했을 때 지도가 줌인되지 않도록 설정 후 사용한다.
     */
    onClusterclick?: ((target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void) | undefined;
    /**
     * 클러스터 마커를 마우스 오버 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 마우스 오버한 Cluster 객체가 넘어온다.
     */
    onClusterover?: ((target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void) | undefined;
    /**
     * 클러스터 마커를 마우스 아웃 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 마우스 아웃된 Cluster 객체가 넘어온다.
     */
    onClusterout?: ((target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void) | undefined;
    /**
     * 클러스터 마커를 더블클릭 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 더블클릭한 Cluster 객체가 넘어온다.
     * MarkerClusterer 를 생성할 때 disableClickZoom 옵션을 true로 설정해야만 이벤트가 발생한다.
     */
    onClusterdblclick?: ((target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void) | undefined;
    /**
     * 클러스터 마커를 오른쪽 클릭 했을 때 발생한다
     * 이벤트 핸들러 함수 인자로는 오른쪽 클릭한 Cluster 객체가 넘어온다.
     */
    onClusterrightclick?: ((target: kakao.maps.MarkerClusterer, cluster: kakao.maps.Cluster) => void) | undefined;
    /**
     * 클러스터링이 완료됐을 때 발생한다.
     * 이벤트 핸들러 함수 인자로는 생성된 Cluster 객체 전체가 배열로 넘어온다.
     */
    onClustered?: ((target: kakao.maps.MarkerClusterer, clusters: kakao.maps.Cluster[]) => void) | undefined;
    /**
     * MarkerClusterer 생성 후 해당 객체를 전달하는 함수
     */
    onCreate?: ((target: kakao.maps.MarkerClusterer) => void) | undefined;
} & {
